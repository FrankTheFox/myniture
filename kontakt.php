...
final class Page
{
    ...
    {        
        ...
        $this->contact_form_ = new ContactForm();
                
        $send_mail = $this->contact_form_->SendMail();
            
        if($send_mail === true){
            header('location: /myniture/kontakt-bestaetigung.php');
            die();
        }   
    }
